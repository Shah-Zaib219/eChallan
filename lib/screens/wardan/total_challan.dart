...
class TotalChallan extends StatelessWidget {
  TotalChallan({super.key});
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      //  const SerchFilter(),
                      Obx(() {
                        if (adminController.challanList.isEmpty) {
                          return Expanded(
                            child: Center(
                        ...
                        return Expanded(
                          child: ListView.separated(
                              itemBuilder: (context, index) {
                                var user = adminController.challanList[index];
                                return ChallanCard(
                                  title:
                              ...
                              separatorBuilder: (context, index) =>
                                  SizedBox(height: 2.h),
                              itemCount: adminController.challanList.length),
                        );
                      }),
                      SizedBox(height: 2.h),
                      ButtomButtom(
